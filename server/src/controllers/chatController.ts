...
import { generateChatResponseStream } from '../services/aiService.js';
...
export const sendMessage = async (req: AuthRequest, res: Response) => {
  ...
  try {
    ...
    const contexts = await retrieveContext(text, 4, req.companyId?.toString());
...
3. If the information is not present in the documentation (or if the context is empty), clearly state:
   "I am sorry, but the requested information is not available in our official documentation."
